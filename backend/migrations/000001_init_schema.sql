...
CREATE INDEX "posts_folder_id_idx" ON "posts" ("folder_id");
CREATE INDEX "posts_status_idx" ON "posts" ("status") WHERE "status" = 'normal';
CREATE INDEX "posts_created_at_idx" ON "posts" ("created_at" DESC);

ALTER TABLE "posts"
  ADD CONSTRAINT "posts_folder_id_fk"
  FOREIGN KEY ("folder_id") REFERENCES "folders" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;
